...
func (suite *AdapterTestSuite) TestValidMessage() {
	...
	suite.Equal("github.com/artificialinc/contrib/entproto/internal/entprototest/ent/proto/entpb",
...
func (suite *AdapterTestSuite) TestMessageWithPackageName() {
	...
	suite.Equal("github.com/artificialinc/contrib/entproto/internal/entprototest/ent/proto/io/entgo/apps/todo",
		fd.GetFileOptions().GetGoPackage())
}
